...
<body>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<p><img src='iconset/iv-bag.png' alt='blood backflow Icon' style='width: 24px; height: 24px;'> <br>" . " <svg width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><circle cx='12' cy='12' r='10' stroke='black' stroke-width='2' fill='{$bag_circle_color}' /></svg> " . "</p>";
            echo "<p><img src='iconset/blood.png' alt='blood backflow Icon' style='width: 24px; height: 24px;'> <br>" . " <svg width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><circle cx='12' cy='12' r='10' stroke='black' stroke-width='2' fill='{$bloodid_circle}' /></svg> " . "</p>";
            echo "</div>";
            echo "<div>";
